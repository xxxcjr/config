...
" Version: 3.2
" Last Modified: 2010年11月20日 星期六 13时12分46秒 [Athena]
"
" Overview
" --------
...
function! s:MRU_add_files_to_menu(prefix, file_list)
	...
	let menu_path = '&Recent.'.'[&'.s:cnt.']\ \ ' . a:prefix . esc_fname . '\ \ <Tab>\ \ ' . esc_dir_name
    let s:cnt=s:cnt+1
...
function! s:MRU_Refresh_Menu()
    ...
    10noremenu &Recent.Dummy <Nop>
    silent! unmenu! &Recent

    anoremenu <silent> &Recent.Re&fresh
